...
class AuthService {
  ...
  Future<User?> createUserWithEmailAndPassword(String email, String password) async {
    try{
      final createCredentials = await _auth.createUserWithEmailAndPassword(email: email, password: password);
  ...
  Future<User?> loginUserWithEmailPassword(String email, String password) async {
    try{
      final loginCredentials = await _auth.signInWithEmailAndPassword(email: email, password: password);
